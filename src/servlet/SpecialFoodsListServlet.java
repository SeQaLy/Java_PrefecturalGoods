...
@WebServlet( "/SpecialFoodsList" )
public class SpecialFoodsListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    @Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	HttpSession session = request.getSession();
    	// ソート方法などをセッションで保持しているためここで削除
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	// 行数のカウント
		allRowCount = specialFoodsListService.countRow();
		...
		foodList = specialFoodsListService.provide( startAt, maxViewSize );
